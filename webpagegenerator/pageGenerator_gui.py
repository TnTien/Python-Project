...
def load_gui(self):
    #   Display text above Entry
    self.lbl_message = tk.Label(self.master, text="Enter name of HTML file to edit or to create new:")
    self.lbl_message.grid(row=0, column=0, padx=(27,0), pady=(10,0), sticky=N+W)
    #   Name of new file or to modify existing file
    self.lbl_newPage = tk.Entry(self.master, text='', width=47)
    self.lbl_newPage.grid(row=1, column=0, padx=(27,0), pady=(5,0), sticky=W)


    #   Displays text above the text box
    self.lbl_message = tk.Label(self.master, text="Enter message to display:")
    self.lbl_message.grid(row=2, column=0, padx=(27,0), pady=(5,0), sticky=N+W)

    #   Text box to enter new text to update the body of the HTML
    self.msgEntry = tk.Text(self.master, height=8, width=35)
    self.msgEntry.grid(row=3, column=0, columnspan=2, padx=(27,5), pady=(5,5), sticky=N+W)
    ...
    self.btn_check.grid(row=4, column=0,padx=(27,0), pady=(5,5), sticky=W)
    ...
    self.btn_clear.grid(row=5, column=0,padx=(27,0), pady=(5,5), sticky=W)
    #   Closes the program
    self.btn_close = tk.Button(self.master,width=12, text='Close Program', command=lambda: pageGenerator_func.ask_quit(self))
    self.btn_close.grid(row=4, column=0,padx=(0,1), pady=(5,5),sticky=E)
